...
export default function WwTestimonialOverlay({ content, skin }: { content: any; skin: Skin }) {
  ...
  return (
    <section className="wwtesti" style={{ background: "var(--c-panel)", color: "var(--c-on-panel)" }}>
      <style>{`
        ...
        .wwtesti__intro { color: color-mix(in srgb, var(--c-on-panel) 60%, transparent); font-size: 0.875rem; line-height: 1.7; max-width: 28rem; margin: 0 auto; }
        .wwtesti__card {
        ...
        .wwtesti__quote {
          ...
          color: var(--c-on-panel); line-height: 1.35; max-width: 48rem; margin-bottom: 1.5rem;
        }
        .wwtesti__name {
