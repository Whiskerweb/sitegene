  ...
  return (
    <div className="px-5 pt-32 md:px-10 md:pt-40">
      <section className="mx-auto max-w-6xl">
        ...
        {content.description ? (
          <FadeIn delay={0.1}>
            <p className="mt-6 max-w-xl text-sm leading-relaxed text-tg-mut">{content.description}</p>
          </FadeIn>
        ) : null}
      </section>
      ...
      {content.cta ? (
        <section className="mx-auto max-w-6xl px-5 py-20 md:px-10">
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full bg-tg-ink px-7 py-3.5 text-sm font-semibold text-white transition-transform hover:scale-[1.04]"
          >
            {content.cta}
