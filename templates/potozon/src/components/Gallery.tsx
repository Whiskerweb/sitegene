...
function Card({ card, delay }: { card: GalleryCard; delay: number }) {
  return (
    <motion.div
  ...
  return (
    <section id="portfolio" className="relative mt-6 md:mt-10">
      ...
      <div className="relative flex flex-wrap items-start justify-center gap-4 md:flex-nowrap md:gap-6">
        ...
        <Card card={cards[1]} delay={0.25} />
        <Card card={cards[2]} delay={0.35} />
        ...
        >
          <p className="text-base font-medium leading-snug text-poto-ink">
            {textRight.body}
          </p>
          <a
            href="#projects"
